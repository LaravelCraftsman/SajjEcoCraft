            ...
            <div class="col-md-10">
                ...
                <div class="card">
                    <div class="card-header">
                        {{ __('Create Invoice') }}
                        <a href="{{ route('invoices.index') }}" class="btn btn-secondary btn-sm" style="float: right;">Back</a>
                    </div>
                            ...
                            <div class="mb-3 mt-3">
                                ...
                                <select name="status" id="status"
                                    ...
                                    @foreach (['draft', 'sent', 'paid'] as $status)
                                        <option value="{{ $status }}"
                                            {{ old('status') == $status ? 'selected' : ($status == 'draft' ? 'selected' : '') }}>
                                            {{ ucfirst($status) }}
                                        </option>
                                    @endforeach
                                </select>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (invoiceInput && !invoiceInput.value) {
                ...
                invoiceInput.value = `INV${last6}SEC`;
            }
